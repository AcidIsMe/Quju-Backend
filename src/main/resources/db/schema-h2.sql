...
MERGE INTO activity_templates (id, name, category, description, tags, activity_type, preset_duration_minutes, preset_max_participants, is_system) KEY(id)
VALUES ('tpl_badminton', '羽毛球两小时', '运动健身', '两小时羽毛球双打局，自带球拍，场地费AA', '["羽毛球","运动","周末"]', '运动健身', 120, 16, TRUE);

MERGE INTO activity_templates (id, name, category, description, tags, activity_type, preset_duration_minutes, preset_max_participants, is_system) KEY(id)
VALUES ('tpl_dinner', '周末聚餐', '聚餐美食', '选定一家口碑餐厅，边吃边聊，费用AA', '["美食","聚餐","周末"]', '聚餐美食', 120, 10, TRUE);

MERGE INTO activity_templates (id, name, category, description, tags, activity_type, preset_duration_minutes, preset_max_participants, is_system) KEY(id)
VALUES ('tpl_study_group', '读书分享会', '学习交流', '每人分享一本最近在读的书，自由讨论交流心得', '["读书","分享","学习"]', '学习交流', 150, 15, TRUE);

MERGE INTO activity_templates (id, name, category, description, tags, activity_type, preset_duration_minutes, preset_max_participants, is_system) KEY(id)
VALUES ('tpl_volunteer', '社区公益行', '公益活动', '参与社区志愿服务，清理公共空间或探访老人', '["公益","志愿","社区"]', '公益活动', 180, 20, TRUE);

MERGE INTO activity_templates (id, name, category, description, tags, activity_type, preset_duration_minutes, preset_max_participants, is_system) KEY(id)
VALUES ('tpl_city_walk', '城市漫步打卡', '城市探索', '沿一条精选路线步行探索，打卡隐藏小店和街景', '["城市","步行","打卡"]', '城市探索', 150, 15, TRUE);

MERGE INTO activity_templates (id, name, category, description, tags, activity_type, preset_duration_minutes, preset_max_participants, is_system) KEY(id)
VALUES ('tpl_yoga', '晨间公园瑜伽', '运动健身', '清晨公园草坪瑜伽练习，适合所有水平', '["瑜伽","健身","清晨"]', '运动健身', 60, 12, TRUE);

MERGE INTO activity_templates (id, name, category, description, tags, activity_type, preset_duration_minutes, preset_max_participants, is_system) KEY(id)
VALUES ('tpl_photography', '主题摄影外拍', '城市探索', '围绕一个主题进行户外拍摄，结束后互相点评作品', '["摄影","户外","创作"]', '城市探索', 180, 10, TRUE);
